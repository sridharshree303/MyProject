...
public class CustomerController {
	...
	public ResponseEntity<Customer> deleteCustomerById(@Valid @PathVariable int customerId)
			throws CustomerNotFoundException {
	...
	public ResponseEntity<Customer> viewCustomerById(@Valid @PathVariable(name = "customerId") int customerId)
			throws CustomerNotFoundException {
