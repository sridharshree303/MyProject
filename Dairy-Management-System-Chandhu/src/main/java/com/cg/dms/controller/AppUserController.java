...
import com.cg.dms.service.AppUserService;
...
public class AppUserController {
	...
	public ResponseEntity<AppUser> register(@RequestBody AppUser appUser) throws AppUserAlreadyExistsException {
	...
	@PostMapping("/login")
	public ResponseEntity<AppUser> login(@RequestBody AppUser appUser) throws AppUserNotFoundException {
	...
	@PostMapping("/logout")
	public ResponseEntity<String> logout(@RequestBody String userName) throws AppUserNotFoundException {
